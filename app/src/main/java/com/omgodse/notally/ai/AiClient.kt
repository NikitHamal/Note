...
class AiClient {
    ...
    // Hardcoded cookies and headers from working curl example
    ...
    fun chatComplete(
        ...
        val request = Request.Builder()
            .url(baseUrl)
            .post(requestBody)
            .header("authority", "chat.together.ai")
            .header("accept", "*/*")
